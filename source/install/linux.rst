...
.. code-block:: bash
   ...
   # On Ubuntu 18.04 LTS
   apt install xauth htop curl apache2 libapache2-mod-fcgid libapache2-mod-php7.2 php7.2-cgi php7.2-gd php7.2-sqlite3 php7.2-curl php7.2-xmlrpc php7.2-xml python-simplejson software-properties-common
